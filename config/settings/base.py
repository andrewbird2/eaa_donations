...
APPS_DIR = ROOT_DIR.path('eaa_donations')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///eaa_donations'),
}
...
MIGRATION_MODULES = {
    'sites': 'eaa_donations.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Andrew Bird""", 'andrewbirdemail@gmail.com'),
]
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['eaa_donations.taskapp.celery.CeleryAppConfig']
if USE_TZ:
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'eaa_donations.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
